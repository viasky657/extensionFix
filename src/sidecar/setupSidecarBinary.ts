...
import { downloadFromGCPBucket, downloadUsingURL } from '../gcp/gcpBucket';
import { sidecarUseSelfRun } from '../sidecar/sidecarUrl';
...
async function checkCorrectVersionRunning(url: string): Promise<boolean> {
    try {
        ...
        // zi: any is used here because the response is not typed
