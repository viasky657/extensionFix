...
const Spinner = () => (
	<div className="h-4 w-4 animate-spin rounded-full border-2 border-button-primary-foreground" />
);
		...
		case 'fs_file_path':
			return (
				...
				>
					<span
						aria-hidden
						className="codicon codicon-file flex-shrink-0 translate-y-0.5"
					/>
			...
			return (
				<div className="bg-sideBarSectionHeader-background border-sideBarSectionHeader-border rounded border text-xs">
					<div className="text-editorHint-foreground border-sideBarSectionHeader-border flex gap-2 border-b px-2 py-2">
						<span
							aria-hidden
							className="codicon codicon-terminal flex-shrink-0 translate-y-0.5"
						/>
					...
					<div className="space-y-1 px-2 py-2 font-mono">
						{content.split('\n').map((line, i) => (
							<div
								...
								className={
									line === delta
										? 'text-editor-selectionForeground'
			...
			return (
				<div className="rounded border border-green-600/30 bg-green-950/30 px-3 py-2">
					<div className="mb-2 flex gap-2 text-green-400">
						<span
							aria-hidden
							className="codicon codicon-check flex-shrink translate-y-0.5"
						/>
