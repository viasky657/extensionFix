	...
	return (
		<RUISelect.Root {...rest}>
			<RUISelect.Trigger
				className={cn(
					className,
					'mr-auto flex items-start gap-2 rounded border border-dropdown-border bg-dropdown-background px-2 py-1 text-dropdown-foreground'
				)}
			>
				<RUISelect.Value />
				<span
...
export function Option(props: OptionProps) {
	...
	return (
		<RUISelect.Item
			...
			{...rest}
		>
			<RUISelect.ItemText>{props.value}</RUISelect.ItemText>
